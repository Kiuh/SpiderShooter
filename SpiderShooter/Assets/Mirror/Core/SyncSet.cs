...
namespace Mirror
{
    public class SyncSet<T> : SyncObject, ISet<T>
    {
        ...
        private void AddOperation(Operation op, T item, bool checkAccess)
        {
            ...
            Change change = new() { operation = op, item = item };
        ...
        public void IntersectWith(IEnumerable<T> other)
        {
            ...
            {
                HashSet<T> otherAsSet = new(other);
    ...
    public class SyncHashSet<T> : SyncSet<T>
    {
        ...
        public SyncHashSet(IEqualityComparer<T> comparer)
            : base(new HashSet<T>(comparer ?? EqualityComparer<T>.Default)) { }
    ...
    public class SyncSortedSet<T> : SyncSet<T>
    {
        ...
        public SyncSortedSet(IComparer<T> comparer)
            : base(new SortedSet<T>(comparer ?? Comparer<T>.Default)) { }
