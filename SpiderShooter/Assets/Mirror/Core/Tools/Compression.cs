...
namespace Mirror
{
    ...
    public static class Compression
    {
        ...
        public static bool ScaleToLong(float value, float precision, out long result)
        {
            ...
            if (precision == 0)
            {
                throw new DivideByZeroException(
                    $"ScaleToLong: precision=0 would cause null division. If rounding isn't wanted, don't call this function."
                );
            }
        ...
        public static bool ScaleToLong(
            Vector3 value,
            float precision,
            out long x,
            out long y,
        ...
        public static ushort ScaleFloatToUShort(
            float value,
            float minValue,
            float maxValue,
            ushort minTarget,
        ...
        // note: can also use this for byte range from byte.MinValue to byte.MaxValue
        public static float ScaleUShortToFloat(
            ushort value,
            ushort minValue,
            ushort maxValue,
            float minTarget,
        ...
        public static int LargestAbsoluteComponentIndex(
            Vector4 value,
        ...
        public static uint CompressQuaternion(Quaternion q)
        {
            ...
            int largestIndex = LargestAbsoluteComponentIndex(
            ...
            ushort aScaled = ScaleFloatToUShort(
                withoutLargest.x,
                QuaternionMinRange,
                QuaternionMaxRange,
                0,
            ...
            ushort bScaled = ScaleFloatToUShort(
                withoutLargest.y,
                QuaternionMinRange,
                QuaternionMaxRange,
                0,
            ...
            ushort cScaled = ScaleFloatToUShort(
                withoutLargest.z,
                QuaternionMinRange,
                QuaternionMaxRange,
                0,
        ...
        private static Quaternion QuaternionNormalizeSafe(Quaternion value)
        {
            ...
            Vector4 v = new(value.x, value.y, value.z, value.w);
        ...
        public static Quaternion DecompressQuaternion(uint data)
        {
            ...
            Vector4 value = largestIndex switch
            {
