...
namespace Mirror
{
    ...
    public static class NetworkWriterExtensions
    {
        ...
        {
            writer.WriteBlittableNullable(
                value.HasValue ? ((byte)(value.Value ? 1 : 0)) : new byte?()
            );
        }
        ...
        public static void WriteString(this NetworkWriter writer, string value)
        {
            ...
            int written = writer.encoding.GetBytes(
                value,
                0,
                value.Length,
                writer.buffer,
        ...
        public static void WriteBytesAndSizeSegment(
