...
namespace Mirror
{
    public static partial class NetworkClient
    {
        ...
        [Obsolete(
            "NetworkClient snapshot interpolation settings were moved to NetworkClient.snapshotSettings.*"
        )]
        ...
        public static double initialBufferTime =>
            NetworkServer.sendInterval * snapshotSettings.bufferTimeMultiplier;
        ...
        private static void InitTimeInterpolation()
        {
            ...
            driftEma = new ExponentialMovingAverage(
                NetworkServer.sendRate * snapshotSettings.driftEmaDuration
            );
            deliveryTimeEma = new ExponentialMovingAverage(
                NetworkServer.sendRate * snapshotSettings.deliveryTimeEmaDuration
            );
        }
