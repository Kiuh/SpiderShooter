...
namespace Mirror
{
    ...
    public class TelepathyTransport : Transport, PortTransport
    {
        ...
        [Tooltip(
            "Receive timeout in milliseconds. High by default so users don't time out during scene changes."
        )]
        ...
        public override void ClientEarlyUpdate()
        {
            ...
            _ = (client?.Tick(clientMaxReceivesPerTick, enabledCheck));
        }
        ...
        {
            _ = (server?.Send(connectionId, segment));
        ...
        {
            _ = (server?.Disconnect(connectionId));
        }
        ...
        public override void ServerEarlyUpdate()
        {
            ...
            // IMPORTANT: check .enabled to stop processing immediately after a
            //            scene change message arrives!
            _ = (server?.Tick(serverMaxReceivesPerTick, enabledCheck));
        }
