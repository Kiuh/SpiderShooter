...
namespace Mirror.SimpleWeb
{
    public static class Log
    {
        ...
        public static void InfoException(Exception e)
        {
            ...
            logger.Log(
                LogType.Log,
                $"[SimpleWebTransport] INFO_EXCEPTION: {e.GetType().Name} Message: {e.Message}\n{e.StackTrace}\n\n"
            );
#else
            logger.Log(
                LogType.Log,
        ...
        public static void Warn(string msg, bool showColor = true)
        {
            ...
            if (showColor)
            {
                logger.Log(
                    LogType.Warning,
                    $"[SimpleWebTransport] WARN: <color=orange>{msg}</color>"
                );
            }
            else
            {
        ...
        public static void Exception(Exception e)
        {
            ...
            logger.Log(
                LogType.Error,
                $"[SimpleWebTransport] EXCEPTION: {e.GetType().Name} Message: {e.Message}\n{e.StackTrace}\n\n"
            );
#else
            logger.Log(
                LogType.Error,
