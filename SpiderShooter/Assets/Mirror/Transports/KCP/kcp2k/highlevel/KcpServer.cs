    ...
    public class KcpServer
    {
        ...
        private static Socket CreateServerSocket(bool DualMode, ushort port)
        {
            if (DualMode)
            {
                ...
                Socket socket =
                    new(AddressFamily.InterNetworkV6, SocketType.Dgram, ProtocolType.Udp);
                ...
                {
                    Log.Warning(
                        $"Failed to set Dual Mode, continuing with IPv6 without Dual Mode. Error: {e}"
                    );
                }
        ...
        {
            return connections.TryGetValue(connectionId, out KcpServerConnection connection)
        ...
        protected virtual void RawSend(int connectionId, ArraySegment<byte> data)
        {
            ...
            try
            {
                _ = socket.SendToNonBlocking(data, connection.remoteEndPoint);
            }
            catch (SocketException e)
            {
        ...
        protected virtual KcpServerConnection CreateConnection(int connectionId)
        {
            ...
            void RawSendWrap(ArraySegment<byte> data)
            {
            ...
            KcpServerConnection connection = new(newClientEP);
            ...
            void OnDisconnectedWrap()
            {
                ...
                _ = connectionsToRemove.Add(connectionId);
