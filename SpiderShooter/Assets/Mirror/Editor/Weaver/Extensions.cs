    ...
    public static class Extensions
    {
        ...
        public static bool IsDerivedFrom(this TypeReference tr, Type baseClass)
        {
            ...
            return parent != null
                && (
                    parent.Is(baseClass)
                    || (parent.CanBeResolved() && IsDerivedFrom(parent.Resolve(), baseClass))
                );
        }
        ...
        public static MethodReference MakeGeneric(
            this MethodReference generic,
            ModuleDefinition module,
            TypeReference variableReference
        )
        {
            GenericInstanceMethod instance = new(generic);
        ...
        )
        {
            MethodReference reference =
                new(self.Name, self.ReturnType, instanceType)
                {
        ...
        {
            GenericInstanceType declaringType = new(self.DeclaringType);
            foreach (GenericParameter parameter in self.DeclaringType.GenericParameters)
            {
        ...
        // Creates a reference to the specialized method  ArraySegment`int`.get_Count
        // Note that calling ArraySegment`T.get_Count directly gives an invalid IL error
        public static FieldReference SpecializeField(
            this FieldReference self,
            ModuleDefinition module,
            GenericInstanceType instanceType
        )
        {
            FieldReference reference = new(self.Name, self.FieldType, instanceType);
            return module.ImportReference(reference);
        }

        public static CustomAttribute GetCustomAttribute<TAttribute>(
        ...
        {
            return attributeProvider.CustomAttributes.Any(
                attr => attr.AttributeType.Is<TAttribute>()
            );
        }
        ...
        public static MethodDefinition GetMethodInBaseType(
        ...
        // Finds public fields in type and base type
        public static IEnumerable<FieldDefinition> FindAllPublicFields(
        ...
        public static AssemblyNameReference FindReference(
            this ModuleDefinition module,
        ...
        public static TypeReference ApplyGenericParameters(
            this TypeReference parentReference,
        ...
        )
        {
            ...
            GenericInstanceType generic = new(parentReference.Resolve());
        ...
        // Originally by James-Frowen under MIT
        // https://github.com/MirageNet/Mirage/commit/cf91e1d54796866d2cf87f8e919bb5c681977e45
        private static TypeReference FindMatchingGenericArgument(
            TypeReference childReference,
            string paramName
        )
        {
