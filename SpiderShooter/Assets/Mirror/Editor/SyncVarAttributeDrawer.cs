...
namespace Mirror
{
    ...
    public class SyncVarAttributeDrawer : PropertyDrawer
    {
        private static readonly GUIContent syncVarIndicatorContent =
            new("SyncVar", "This variable has been marked with the [SyncVar] attribute.");
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Rect labelRect =
                new(position.x + valueWidth, position.y, syncVarIndicatorRect.x, position.height);

            _ = EditorGUI.PropertyField(valueRect, property, label, true);
