...
namespace Mirror
{
    ...
    public class NetworkRoomManager : NetworkManager
    {
        ...
        public List<PendingPlayer> pendingPlayers = new();
        ...
        public List<NetworkRoomPlayer> roomSlots = new();
        ...
        {
            Debug.Log(
                $"NetworkRoom SceneLoadedForPlayer scene: {SceneManager.GetActiveScene().path} {conn}"
            );
            ...
            _ = NetworkServer.ReplacePlayerForConnection(conn, gamePlayer, true);
        }
        ...
        public void CheckReadyToBegin()
        {
            ...
            int numberOfReadyPlayers = NetworkServer.connections.Count(
                conn =>
                    conn.Value != null
        ...
        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            ...
            if (Utils.IsSceneActive(RoomScene))
            {
                ...
                _ = NetworkServer.AddPlayerForConnection(conn, newRoomGameObject);
            }
            else
            {
            ...
            if (newSceneName == RoomScene)
            {
                foreach (NetworkRoomPlayer roomPlayer in roomSlots)
                {
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        _ = NetworkServer.ReplacePlayerForConnection(
        ...
        public virtual bool OnRoomServerSceneLoadedForPlayer(
            NetworkConnectionToClient conn,
            GameObject roomPlayer,
