...
namespace Mirror
{
    ...
    public class TeamInterestManagement : InterestManagement
    {
        ...
        public override void OnSpawned(NetworkIdentity identity)
        {
            ...
            _ = dirtyTeams.Add(networkTeamId);
        }
        ...
        public override void OnDestroyed(NetworkIdentity identity)
        {
            ...
            {
                _ = lastObjectTeam.Remove(identity);
                if (
        ...
        private void UpdateDirtyTeams(string newTeam, string currentTeam)
        {
            ...
            _ = dirtyTeams.Add(newTeam);
        }

        private void UpdateTeamObjects(
        ...
        )
        {
            ...
            if (!string.IsNullOrWhiteSpace(currentTeam))
            {
                _ = teamObjects[currentTeam].Remove(netIdentity);
            }
            ...
            _ = teamObjects[newTeam].Add(netIdentity);
        }
