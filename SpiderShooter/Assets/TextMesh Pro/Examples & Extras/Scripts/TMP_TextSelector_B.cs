            ...
            IPointerUpHandler
    {
        ...
        private void Awake()
        {
            ...
            m_TextPopup_TMPComponent =
                m_TextPopup_RectTransform.GetComponentInChildren<TextMeshProUGUI>();
        ...
        private void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                )
                {
                    ...
                    int materialIndex = m_TextMeshPro.textInfo.characterInfo[
                        charIndex
                    ...
                    Vector2 charMidBasline =
                        (vertices[vertexIndex + 0] + vertices[vertexIndex + 2]) / 2;
                    ...
                    m_matrix = Matrix4x4.TRS(
                        Vector3.zero,
                        Quaternion.identity,
                        Vector3.one * zoomFactor
                    );

                    // Apply Matrix operation on the given character.
                    vertices[vertexIndex + 0] = m_matrix.MultiplyPoint3x4(
                        vertices[vertexIndex + 0]
                    );
                    vertices[vertexIndex + 1] = m_matrix.MultiplyPoint3x4(
                        vertices[vertexIndex + 1]
                    );
                    vertices[vertexIndex + 2] = m_matrix.MultiplyPoint3x4(
                        vertices[vertexIndex + 2]
                    );
                    vertices[vertexIndex + 3] = m_matrix.MultiplyPoint3x4(
                    ...
                    Color32[] vertexColors = m_TextMeshPro.textInfo.meshInfo[
                        materialIndex
                    ].colors32;
                ...
                if (
                    m_TextPopup_RectTransform != null
                    && m_selectedWord != -1
                ...
                )
                {
                    ...
                    for (int i = 0; i < wInfo.characterCount; i++)
                    {
                        ...
                        // Get the index of the material / sub text object used by this character.
                        int meshIndex = m_TextMeshPro.textInfo.characterInfo[
                            characterIndex
                        ].materialReferenceIndex;

                        // Get the index of the first vertex of this character.
                        int vertexIndex = m_TextMeshPro.textInfo.characterInfo[
                            characterIndex
                        ].vertexIndex;
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    _ = RectTransformUtility.ScreenPointToWorldPointInRectangle(
                        m_TextMeshPro.rectTransform,
                        Input.mousePosition,
                        m_Camera,
                        out Vector3 worldPointInRectangle
                    );
