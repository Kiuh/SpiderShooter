        ...
        private void LateUpdate()
        {
            ...
            )
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex)
                {
                    ...
                    TMP_TextElementType elementType = m_TextComponent.textInfo.characterInfo[
                        charIndex
                    ].elementType;
                    ...
                    if (elementType == TMP_TextElementType.Character)
                    {
                        SendOnCharacterSelection(
                            m_TextComponent.textInfo.characterInfo[charIndex].character,
                            charIndex
                        );
                    }
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    SendOnWordSelection(
                        wInfo.GetWord(),
                        wInfo.firstCharacterIndex,
                        wInfo.characterCount
                    );
                }
                #endregion
                ...
                if (lineIndex != -1 && lineIndex != m_lastLineIndex)
                {
                    ...
                    for (
                        int i = 0;
                        i < lineInfo.characterCount
                            && i < m_TextComponent.textInfo.characterInfo.Length;
                        i++
                    )
                    {
                        buffer[i] = m_TextComponent.textInfo.characterInfo[
                            i + lineInfo.firstCharacterIndex
                        ].character;
                    }
