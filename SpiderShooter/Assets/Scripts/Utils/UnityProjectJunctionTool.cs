...
public static class UnityProjectJunctionTool
{
    ...
    {
        DirectoryInfo projectDirectoryInfo = new(Directory.GetCurrentDirectory());
            ...
            else
            {
                ...
                do
                {
                    ...
                    junctionPath = Path.Combine(
                        projectDirectoryInfo.Parent.FullName,
                        junctionDirectory
                    );
        ...
        string linkProjectSettings = Path.Combine(
            junctionDirectoryInfo.FullName,
            "ProjectSettings"
        );
        ...
        string targetProjectSettings = Path.Combine(
        ...
        _ = EditorUtility.DisplayDialog(
            "Complete",
            $"Created junction project at {junctionPath}.\n\nYou may now open this new project in a separate Unity Editor instance.",
            "Ok"
        );
    ...
    private static void CreateJunction(string link, string target)
    {
        ...
        else if (Application.platform is RuntimePlatform.OSXEditor or RuntimePlatform.LinuxEditor)
        {
    ...
    public static void LinkWinOS(string link, string target)
    {
        ...
        _ = Process.Start("cmd.exe", command);
    }
